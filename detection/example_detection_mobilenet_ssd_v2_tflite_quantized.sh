...
MODEL="${MODELS_DIR}/lite-model_ssd_mobilenet_v1_1_metadata_2.tflite"
...
MODEL_LABELS="${MODELS_DIR}/lite-model_ssd_mobilenet_v1_1_metadata_2.txt"
...
TENSOR_DECODER+=" option1=mobilenet-ssd-postprocess"
TENSOR_DECODER+=" option2=${MODEL_LABELS}"
TENSOR_DECODER+=" option3=0:1:2:3,60"
